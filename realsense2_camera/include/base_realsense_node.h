...
#define FRAME_ID(sip) (static_cast<std::ostringstream&&>(std::ostringstream()  << (_camera_namespace.empty() ? "" : _camera_namespace + "/") << _camera_name << "_" << STREAM_NAME(sip) << "_frame")).str()
#define IMU_FRAME_ID (static_cast<std::ostringstream&&>(std::ostringstream()  << (_camera_namespace.empty() ? "" : _camera_namespace + "/") << _camera_name << "_imu_frame")).str()
#define IMU_OPTICAL_FRAME_ID (static_cast<std::ostringstream&&>(std::ostringstream()  << (_camera_namespace.empty() ? "" : _camera_namespace + "/") << _camera_name << "_imu_optical_frame")).str()
#define OPTICAL_FRAME_ID(sip) (static_cast<std::ostringstream&&>(std::ostringstream()  << (_camera_namespace.empty() ? "" : _camera_namespace + "/") << _camera_name << "_" << STREAM_NAME(sip) << "_optical_frame")).str()
#define ALIGNED_DEPTH_TO_FRAME_ID(sip) (static_cast<std::ostringstream&&>(std::ostringstream()  << (_camera_namespace.empty() ? "" : _camera_namespace + "/") << _camera_name << "_" << "aligned_depth_to_" << STREAM_NAME(sip) << "_frame")).str()
